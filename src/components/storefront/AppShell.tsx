        ...
        <div className="mt-2 flex items-start justify-between gap-2">
          <div className="min-w-0">
            ...
            <button className="mt-2 flex items-center gap-1.5 text-left text-sm text-ink">
              <Pin className="size-4 shrink-0 text-gold" />
          ...
          <div className="flex shrink-0 items-center gap-1.5">
            <button className="flex items-center gap-1.5 rounded-xl border border-gold-edge bg-gold-wash px-2.5 py-1.5 text-[13px] text-gold">
    ...
    <header className="sticky top-0 z-40 hidden border-b border-line bg-bg/90 backdrop-blur lg:block">
      <div className="mx-auto flex max-w-[1400px] items-center gap-6 px-6 py-4">
        ...
        <button className="flex shrink-0 items-center gap-1.5 rounded-xl border border-line bg-surface px-3 py-2 text-sm">
          <Pin className="size-4 text-gold" />
        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          <button className="flex items-center gap-1.5 rounded-xl border border-gold-edge bg-gold-wash px-3 py-2 text-sm text-gold">
            <Wallet className="size-4" />
            ₹0
          </button>
          <button className="relative flex items-center gap-2 rounded-xl border border-line bg-surface px-3 py-2 text-sm text-ink hover:bg-hover">
            ...
            Cart
            <span className="grid size-5 place-items-center rounded-full bg-gold text-[11px] font-semibold text-black">
              {CART_COUNT}
            </span>
          </button>
          <button
  ...
  return (
    <aside className="hidden w-56 shrink-0 lg:block">
      <nav aria-label="Sections" className="sticky top-24 py-6">
        ...
        <div className="mt-8 rounded-card border border-gold-edge bg-gold-wash p-4">
          <p className="font-display text-lg text-gold">Quoin Pro</p>
          <p className="mt-1 text-xs leading-relaxed text-muted">
            Trade pricing, priority dispatch and a dedicated project manager.
          </p>
          <button className="mt-3 flex w-full items-center justify-center gap-1 rounded-lg bg-gold px-3 py-2 text-xs font-semibold text-black">
            Join Pro
  ...
  return (
    <div className={className}>
      ...
      <div className="flex items-center gap-3 rounded-2xl border border-line bg-surface px-4 py-3 lg:rounded-xl lg:py-2.5">
        ...
        <button aria-label="Search by voice" className="shrink-0 text-muted hover:text-gold">
